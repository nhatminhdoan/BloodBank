        ...
        public ActionResult Login(UserMV userMV)
        {
            if (ModelState.IsValid)
            {
                ...
                if(user != null)
                {
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "Please Wait, Your Account is Rejected! For more details Contact us");
                    }
                    else if (user.AccountStatusID == 5)
                    {
                        ModelState.AddModelError(string.Empty, "Please Wait, Your Account is Suspended! For more details Contact us");
                    }
                    else if (user.AccountStatusID == 2)
                    {
                        ...
                        else if (user.UserTypeID == 2) // Donor
                        {
                            ...
                            else
                            {
                                ...
                                ModelState.AddModelError(string.Empty, "UserName and Password is Incorrect 1");
                            }
                        }
            ...
            else
            {
                ...
                ModelState.AddModelError(string.Empty, "Please Privide UserName and Password!");
            }
            ClearSession();
            return View(userMV);
        }
